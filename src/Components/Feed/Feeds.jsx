                        ...
                        <div className="max-w-3xl mx-auto bg-cyan-700 p-5 rounded-md shadow-md  mt-20">
                            ...
                            <div className="flex items-center mb-4 ">
                                ...
                                <div className='flex  w-full'>
                                    <p className="text-lg w-80 text-white font-semibold">{item.name}</p>
                                    <p className="text-white w-96 pt-1   flex justify-end ">ID: {item.id}</p>
                                </div>
                            </div>
                            ...
                            <div className="mb-4 border rounded-md p-4">
                                <div className="mb-2">
                                    <label htmlFor="title" className="block text-white text-lg font-bold mb-2">{item.title}</label>
                                </div>

                                <div>
                                    <div className="border p-2 rounded-md">
                                        <div contentEditable="false"  className="placeholder-text text-sm  text-white" placeholder="Enter description...">{item.desc}</div>
                                    </div>
                                </div>
                            </div>
